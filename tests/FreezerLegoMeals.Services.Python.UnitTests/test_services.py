...
class TestMealService:
    ...
    @mock.patch('services.FreezerLegoMeals.Services.Python.meal_service.Repository')
...
class TestShoppingService:
    ...
    @mock.patch('services.FreezerLegoMeals.Services.Python.shopping_service.Repository')
